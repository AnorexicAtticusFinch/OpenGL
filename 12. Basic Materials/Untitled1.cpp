...
int main()
{
    ...
    //LIGHTING PROPERTIES
    simpleMaterial cubeMat;
    cubeMat.ambient = glm::vec3(1, 0.5, 0.31);
    cubeMat.diffuse = glm::vec3(1, 0.5, 0.31);
    cubeMat.specular = glm::vec3(1, 0.5, 0.31);
    cubeMat.shininess = 32;

    lightMaterial lightMat;
    lightMat.position = glm::vec3(1.2, 0.75, 2);
    ...
    while (! glfwWindowShouldClose(window))
    {
        ...
        lightMat.position.x = 1.2 + 4*cos(time);
        lightMat.position.z = 2 + 4*sin(time);
